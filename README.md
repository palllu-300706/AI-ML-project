An intelligent Financial Assistant powered by Retrieval-Augmented Generation (RAG), LangChain, ChromaDB, and Ollama, designed to provide accurate, context-aware financial insights from document-based knowledge sources.
